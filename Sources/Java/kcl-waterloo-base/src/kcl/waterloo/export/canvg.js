    ...
    function build() {
        ...
        svg.Element.RenderedElementBase = function(node) {
            ...
            this.setContext = function(ctx) {
                ...
                if (this.style('stroke-width').hasValue())
                    ctx.lineWidth = this.style('stroke-width').toPixels();
        ...
        svg.Element.GradientBase = function(node) {
            ...
            this.createGradient = function(ctx, element) {
                ...
                if (g == null)
                    return stopsContainer.stops[stopsContainer.stops.length - 1].color;
                ...
                for (var i = 0; i < this.children.length; i++) {
                    ...
                    if (child.attribute('x').hasValue()) {
                        ...
                        if (this.attribute('dx').hasValue())
                            y += this.attribute('dx').toPixels('x');
                    ...
                    if (child.attribute('y').hasValue()) {
                        ...
                        if (this.attribute('dy').hasValue())
                            y += this.attribute('dy').toPixels('y');
