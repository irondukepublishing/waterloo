 ...
 * @author ML
 */
public class GJHalfGauge extends GJGauge {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (buffer == null) {
            ...
            outerGradientPaint = new GradientPaint(getWidth() / 2,
                    ...
                    Color.WHITE,
                    true);
            Arc2D arc0 = new Arc2D.Double(r.getX() + 1,
                    r.getY() + 1,
                    r.getWidth() - 2,
                    r.getHeight() * 1.8 - 2,
                    0d, 180d, Arc2D.CHORD);
            ...
            g2.setClip(area2);
            for (double theta = -Math.PI; theta < 0; theta += Math.PI / ((getMaximum() - getMinimum()) / getMajorTickSpacing())) {
                double x0, y0, x1, y1;
                x0 = arc2.getCenterX();
                y0 = arc2.getCenterY();
            ...
            g2.setClip(area3);
            for (double theta = -Math.PI; theta < 0d; theta += Math.PI / ((getMaximum() - getMinimum()) / getMinorTickSpacing())) {
                double x0, y0, x1, y1;
                x0 = arc2.getCenterX();
                y0 = arc2.getCenterY();
                x1 = arc2.getCenterX() + (Math.cos(theta) * maxR);
            ...
            for (double theta = -Math.PI; theta < 0d; theta += Math.PI / ((getMaximum() - getMinimum()) / getMajorTickSpacing())) {
        ...
        AffineTransform af = AffineTransform.getRotateInstance(-getTheta() - Math.PI / 2d, arc2.getCenterX(), arc2.getCenterY());
