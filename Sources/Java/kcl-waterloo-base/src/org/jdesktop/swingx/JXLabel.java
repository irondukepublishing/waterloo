...
public class JXLabel extends JLabel implements BackgroundPaintable {
    ...
    /**
     * Text alignment enums. Controls alignment of the text when line wrapping
     * is enabled.
     */
...
//    }
    /**
     * Create a new JXLabel. This has the same semantics as creating a new
     * JLabel.
     */
    public JXLabel() {
        super();
    ...
    /**
     * Create a new JXLabel with the given text as the text for the label. This
     * is shorthand for:
     *
     * <pre><code>
    ...
    /**
     * Returns the current foregroundPainter. This is a bound property. By
     * default the foregroundPainter will be an internal painter which executes
     * the standard painting code (paintComponent()).
     *
    ...
    /**
     * Sets a Painter to use to paint the background of this component By
     * default there is already a single painter installed which draws the
     * normal background for this component according to the current Look and
    ...
    /**
     * Sets new value for text rotation. The value can be anything in range
     * <0,2PI>. Note that although property name suggests only text rotation,
     * the whole foreground painter is rotated in fact. Due to various reasons
     * it is strongly discouraged to access any size related properties of the
     * label from other threads then EDT when this property is set.
     *
     ...
     * disabled to mimic default of the JLabel. Value of this property has no
     * effect on HTML text.
     *
    ...
    /**
     * Returns the current status of line wrap support. The default value of
     * this property is false to mimic default JLabel behavior. Value of this
     * property has no effect on HTML text.
     *
