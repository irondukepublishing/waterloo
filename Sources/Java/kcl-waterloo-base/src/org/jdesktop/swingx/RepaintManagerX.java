...
/**
 * <p>
 * An implementation of {@link RepaintManager} which adds support for
 * transparency in {@link JXPanel}s. <code>JXPanel</code> (which supports
 * translucency) will replace the current RepaintManager with an instance of
 * RepaintManagerX
 * <em>unless</em> the current RepaintManager is tagged by the
 * {@link TranslucentRepaintManager} annotation.</p>
 *
 * @author zixle
 * @author rbair
...
public class RepaintManagerX extends ForwardingRepaintManager {
     ...
     *
     * @param delegate the manager backing this {@code RepaintManagerX}
