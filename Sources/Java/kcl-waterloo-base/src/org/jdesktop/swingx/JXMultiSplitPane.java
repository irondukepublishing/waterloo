...
public class JXMultiSplitPane extends JPanel implements BackgroundPaintable {
    ...
    /**
     * Specifies a Painter to use to paint the background of this JXPanel. If
     * <code>p</code> is not null, then setOpaque(false) will be called as a
     ...
     * pixels, such as around the border insets.
     */
    @Override
