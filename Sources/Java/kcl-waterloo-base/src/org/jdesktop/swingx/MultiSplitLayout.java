...
public class MultiSplitLayout implements LayoutManager, Serializable {
     ...
     * the node weights rather than the component preferred sizes. #see setModel
     */
    ...
    /**
     * Set the size of the child components to match the weights of the
     * children. If the components to not all specify a weight then the
    ...
    /**
     * Show/Hide nodes. Any dividers that are no longer required due to one of
     * the nodes being made visible/invisible are also shown/hidden. The
     * visibility of the component managed by the node is also changed by this
     * method
     *
     ...
     * columns to get the overall minimum size for the layout node, including
     * the dividers.
     *
     ...
     * columns to get the overall maximum size for the layout node, including
     * the dividers.
     *
     * @param root the node whose size is required.
     * @return the minimum size.
    ...
    private void layoutShrink(Split split, Rectangle bounds) {
        ...
        if (split.isRowLayout()) {
            ...
            while (splitChildren.hasNext()) {
                ...
                } else /*if ( splitChild.isVisible()) {*/ if ((availableHeight > 0.0) && (splitChildWeight > 0.0)) {
                    double newHeight;
                    double oldHeight = splitChildBounds.getHeight();
    ...
    /**
     * Set the layout mode. By default this layout uses the preferred and
     * minimum sizes of the child components. To ignore the minimum size set the
     * layout mode to MultiSplitLayout.LAYOUT_NO_MIN_SIZE.
     *
     * @param layoutMode the layout mode
     * <ul>
     * <li>DEFAULT_LAYOUT - use the preferred and minimum sizes when sizing the
     * children</li>
     * <li>LAYOUT_NO_MIN_SIZE - ignore the minimum size when sizing the
     * children</li>
     * </li>
     */
    ...
    public static abstract class Node implements Serializable {
        ...
        /**
         * Determines whether this node should be visible when its parent is
         * visible. Nodes are initially visible
         *
    ...
    public static class Split extends Node {
        ...
        /**
         * Default constructor to support xml (de)serialization and other bean
         * spec dependent ops. Resulting instance of Split is invalid until
         * setChildren() is called.
         */
        public Split() {
        }
        ...
        /**
         * Remove a node from the layout. Any sibling dividers will also be
         * removed
         *
        ...
        /**
         * Replace one node with another. This method is used when a child is
         * removed from a split and the split is no longer required, in which
         * case the remaining node in the child split can replace the split in
         * the parent node
         *
        ...
        /**
         * Change a node to being hidden. Any associated divider nodes are also
         * hidden
         *
        ...
        /**
         * Restore any of the hidden dividers that are required to separate
         * visible nodes
         *
        ...
        /**
         * Convenience method for setting the children of this Split node. The
         * parent of each new child is set to this Split node, and the parent of
         * each old child (if any) is set to null. This method defensively
         * copies the incoming array.
         *
