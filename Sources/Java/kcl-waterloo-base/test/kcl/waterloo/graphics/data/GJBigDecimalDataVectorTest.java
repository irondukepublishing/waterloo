 ...
 */
public class GJBigDecimalDataVectorTest {

    public GJBigDecimalDataVectorTest() {
    }
    ...
    /**
     * Test of setDataBufferData method, of class GJBigDecimalDataVector.
     */
    @Test
    public void testSetDataBufferData_doubleArr() {
        System.out.println("setDataBufferData");
        double[] expResult = new double[]{0, 1, 2, 3, 4, 5};
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
    ...
    public void testSetDataBufferData_AbstractList() {
        System.out.println("setDataBufferData");
        AbstractList<BigDecimal> v = new ArrayList<BigDecimal>();
        v.add(BigDecimal.ONE);
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
        instance.setDataBufferData(v);
    ...
    /**
     * Test of setDataBuffer method, of class GJBigDecimalDataVector.
     */
    @Test
    public void testSetDataBuffer() {
        System.out.println("setDataBuffer");
        BigDecimal[] v = new BigDecimal[]{new BigDecimal(0d)};
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
    ...
    /**
     * Test of getDataBuffer method, of class GJBigDecimalDataVector.
     */
    @Test
    public void testGetDataBuffer() {
        System.out.println("getDataBuffer");
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
        BigDecimal[] expResult = new BigDecimal[]{new BigDecimal(0d)};
        instance.setDataBuffer(expResult);
        BigDecimal[] result = instance.getDataBuffer();
        assertTrue(expResult.equals(result));
    }

    /**
     * Test of getDataValues method, of class GJBigDecimalDataVector.
     */
    @Test
    ...
    /**
     * Test of getRawDataValues method, of class GJBigDecimalDataVector.
     */
    @Test
    ...
    /**
     * Test of getEntry method, of class GJBigDecimalDataVector.
     */
    @Test
    ...
    /**
     * Test of setCategory method, of class GJBigDecimalDataVector.
     */
    @Test
    public void testSetEntry() {
        ...
        double val = 0.0;
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
        instance.setDataBuffer(new BigDecimal[]{new BigDecimal(1d)});
        instance.setEntry(index, val);
        assertTrue(new Double(instance.getEntry(index).toString()) == 0d);
    }

    /**
     * Test of getDimension method, of class GJBigDecimalDataVector.
     */
    @Test
    ...
    public void testSetEntry_int_double() {
        ...
        double val = 0.0;
        GJBigDecimalDataVector instance = new GJBigDecimalDataVector();
        BigDecimal[] v = new BigDecimal[]{new BigDecimal(1d)};
        instance.setDataBuffer(v);
        assertTrue(instance.getDataValues(NOPTransform.getInstance())[0] == 1d);
        instance.setEntry(index, val);
     ...
     */
    @Test
    public void testSetEntry_int_BigDecimal() {
        System.out.println("setEntry");
        int index = 0;
