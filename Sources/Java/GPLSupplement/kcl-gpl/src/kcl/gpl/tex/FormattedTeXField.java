...
/**
 * A JFormattedTextField subclass that supports TeX.
 *
 * @author Malcolm Lidierth, King's College London <a href="http://sourceforge.net/p/waterloo/discussion/"> [Contact]</a>
 */
public class FormattedTeXField extends JFormattedTextField
    ...
    public FormattedTeXField() {
        addPropertyChangeListener(this);
        addComponentListener(this);
    }

    private FormattedTeXField(String str) {
        setText(str);
    }

    public static FormattedTeXField createInstance(final String str) {
        FormattedTeXField label = new FormattedTeXField(str);
    ...
    public void paintComponent(Graphics g) {
        if (icon != null) {
            ...
            paintBackground(g2);
            if (textRotation != 0) {
                g2.rotate(textRotation, getWidth() / 2, getHeight() / 2);
            }

            icon.paintIcon(this, g2, getWidth() / 2 - icon.getIconWidth() / 2,
