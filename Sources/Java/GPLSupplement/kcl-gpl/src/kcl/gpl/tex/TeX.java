...
/**
 * A JComponent subclass that supports TeX.
 *
 * @author Malcolm Lidierth
 */
public class TeX extends JComponent
    ...
    private TeX(String str) {
        setText(str);
    }

    public static TeX createInstance(final String str) {
        TeX label = new TeX(str);
