...
ax1=f.getObject().add(GJGraphContainer.createInstance(GJGraph.createInstance()));

f.getObject().makeTabbed('0');
ax2=f.getObject().addTab('1', GJGraphContainer.createInstance(GJGraph.createInstance()));
ax3=f.getObject().addTab('2',GJGraphContainer.createInstance(GJGraph.createInstance()));
ax4=f.getObject().addTab('3', GJGraphContainer.createInstance(GJGraph.createInstance()));
...
ax1.getComponent(0).getView().autoScale();
